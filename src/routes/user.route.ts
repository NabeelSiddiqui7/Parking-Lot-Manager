...
class UserRoute implements Route {
    ...
    public initializeRoutes() {
        ...
        this.router.get(`${this.path}/lots`, async (req: Request, res: Response, next: NextFunction) => {
            const sortField: "ASC" | "DESC" = req.query.sortField?.toString()?.toUpperCase() as "ASC" | "DESC"; // change this to be req.params.<varname> or req.body.<varname> dependent on how you make the request
